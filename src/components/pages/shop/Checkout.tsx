                        ...
                        <Row>
                            ...
                            <Col className='col-12 mb-3 '>
                                <label htmlFor="company" style={{display:"inline-block"}}>COMPANY <span>*</span></label>
                                    <input type="text"  style={{display:"block",width:"31%"}} id='company' {...register("company" ,{
                                        required:{
                                            value:true,
                            ...
                            <Col className='col-12 mb-3 '>
                                <label htmlFor="country" style={{display:"inline-block"}}>COUNTRY <span>*</span></label>
                                    <input type="text"  style={{display:"block",width:"31%"}} id='country' {...register("country" ,{
                                        required:{
                                            value:true,
                            ...
                            <Col className='col-12 mb-3 '>
                                <label htmlFor="address" style={{display:"inline-block"}}>ADDRESS <span>*</span></label>
                                    <input type="text"  style={{display:"block",width:"31%"}} id='address' {...register("address" ,{
                                        required:{
                                            value:true,
                            ...
                            <Col className='col-12 mb-3 '>
                                <label htmlFor="postcode" style={{display:"inline-block"}}>POSTCODE <span>*</span></label>
                                    <input type="text"  style={{display:"block",width:"31%"}} id='postcode' {...register("postcode" ,{
                                        required:{
                                            value:true,
                            ...
                            <Col className='col-12 mb-3 '>
                                <label htmlFor="city" style={{display:"inline-block"}}>CITY <span>*</span></label>
                                    <input type="text"  style={{display:"block",width:"31%"}} id='firstName' {...register("city" ,{
                                        required:{
                                            value:true,
                            ...
                            <Col className='col-12 mb-3 '>
                                <label htmlFor="province" style={{display:"inline-block"}}>PROVINCE <span>*</span></label>
                                    <input type="text"  style={{display:"block",width:"31%"}} id='firstName' {...register("province" ,{
                                        required:{
                                            value:true,
                            ...
                            <Col className='col-12 mb-3 '>
                                <label htmlFor="phone" style={{display:"inline-block"}}>PHONE <span>*</span></label>
                                    <input type="text"  style={{display:"block",width:"31%"}} id='firstName' {...register("phone" ,{
                                        required:{
                                            value:true,
                            ...
                            <Col className='col-12 mb-3 '>
                                <label htmlFor="email" style={{display:"inline-block"}}>Email <span>*</span></label>
                                    <input type="text"  style={{display:"block",width:"31%"}} id='firstName' {...register("email" ,{
                                        required:{
                                            value:true,
